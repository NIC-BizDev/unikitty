...
export default Ember.Route.extend({
  model: function(params, transition) {
    ...
    return Ember.RSVP.hash({
      ...
      // chart options for chartist
      // We can disable the grid for this x-axis
      //TODO: Make Chart Accessible with chartist plugin https://gionkunz.github.io/chartist-js/plugins.html
      chartOptions: {
        showPoint: false,
        height: 200,
        axisX: {
